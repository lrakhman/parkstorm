namespace :db  do
  ...
  task :after_migrate => :environment do
    ...
    system('psql -d parkstorm_development < db/fixtures/load_wards.sql')
  end
  ...
  task :test_after_prepare => :environment do
    ...
    system('psql -d parkstorm_test < db/fixtures/load_wards.sql')
  end
  ...
  task :travis_after_migrate => :environment do
    ...
    system('psql -d travis_ci_test < db/fixtures/load_wards.sql')
  end
end
